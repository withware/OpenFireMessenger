...
import net.openfiresecurity.messenger.SignUp;
...
public class SignUpSender extends AsyncTask<String, Integer, String> {
     ...
     */
    public SignUpSender(SignUp context) {
        signup = context;
    ...
    protected String doInBackground(String... params) {
        @NotNull String url = Constants.MSGURL + Constants.USER + Constants.SIGNUP;
